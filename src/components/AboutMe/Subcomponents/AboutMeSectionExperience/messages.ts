...
export default defineMessages({
	firstExpTitle: {
		id: 'firstExpTitle',
		defaultMessage: 'Junior fullstack developer',
	},
	secondExpTitle: {
		id: 'secondExpTitle',
