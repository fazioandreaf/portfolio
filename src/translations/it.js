const messages = {
	...
	firstExpDescription:
		"Mi occupo della gestione e dello sviluppo dell'e-commerce nell'industria della moda e del lusso utilizzando Salesforce Commerce Cloud. Sono incline a sviluppare sia il frontend che il backend con varie lingue di programmazione come: Javascript, React, Redux, JQuery, Laravel e Node. Queste lingue sono state studiate nel tempo attraverso le ore di formazione che l'azienda mi fornisce e dalla mia curiosità nel sperimentare nuovi metodi.",
	...
	firstEduDescription:
		"Argomenti soggetti a ulteriori studi: ingegneria elettrica; meccanica applicata alle macchine; scienza delle costruzioni; termodinamica; trasferimento di calore; macchine e sistemi energetici.\n\nScrittura della tesi dal titolo 'Il cambio automatico dell" +
